    ...
    l = function (t) {
      if (
        !t
          ...
          .every(
            (t) => (
              ((t = (t = t.replace(/[#*].*$/, "")).replaceAll(/[()/.*#\s-]+/g, "")).startsWith("+") || t.startsWith("00")) &&
                (t = `+${t.replace(/^[+0]+/, "")}`),
    ...
    A = function (t) {
      if (
        !t
          ...
          .filter((t) => "" !== t)
          .every(
            (t) => !(/^[0-9]{4,}-[0-9]{2}-[0-9]{2}$/.test(t) && /^[0-9]{4,}-[0-9]{2}-[0-9]{2}$/.test(this.threshold) && t < this.threshold)
          )
      )
        throw new o(this);
    },
    z = function (t) {
      if (
        !t
          ...
          .filter((t) => "" !== t)
          .every(
            (t) => !(/^[0-9]{4,}-[0-9]{2}-[0-9]{2}$/.test(t) && /^[0-9]{4,}-[0-9]{2}-[0-9]{2}$/.test(this.threshold) && this.threshold < t)
          )
      )
        throw new o(this);
    },
