      ...
      4206: function () {
        ...
        Flatsome.behavior("nav-hover", {
          attach(t) {
            ...
            n.length &&
              (n.removeClass(e),
              jQuery([".nav-prompts-overlay li.menu-item", ".nav-prompts-overlay .header-vertical-menu__opener"].join(", "), t).on({
        ...
        Flatsome.behavior("sidebar-slider", {
          attach(t) {
            ...
            jQuery(".mobile-sidebar-slide", t).each((t, o) => {
              ...
              jQuery(
                ["> li > ul.children", "> li > .sub-menu", i > 1 ? "> li > ul.children > li > ul" : null].filter(Boolean).join(", "),
                r
              ).each((t, o) => {
                const i = jQuery(o),
                  r = i.parent(),
        ...
        Flatsome.behavior("scroll-to", {
          attach() {
            ...
            o.length
              ...
              : ((o = jQuery('<div class="scroll-to-bullets hide-for-medium"/>')), jQuery("body").append(o)),
      ...
      5958: function () {
        Flatsome.behavior("toggle", {
          attach(e) {
            ...
            jQuery(
              [".widget ul.children", ".nav ul.children", ".menu .sub-menu", ".mobile-sidebar-levels-2 .nav ul.children > li > ul"].join(
                ", "
              ),
              e
            ).each(function () {
        ...
        Flatsome.behavior("youtube", {
          attach(e) {
            ...
            0 !== r.length &&
              ...
              t.getElementById(o) ||
                (((i = t.createElement(n)).id = o), (i.src = "https://www.youtube.com/player_api"), a.parentNode.insertBefore(i, a)));
          },
        });
      },
      3094: function (e, t, n) {
        n.g.Flatsome = {
          ...
          attach(e, t = e) {
            if ("string" == typeof e)
              return this.behaviors.hasOwnProperty(e) && "function" == typeof this.behaviors[e].attach
          ...
          detach(e, t = e) {
            if ("string" == typeof e)
              return this.behaviors.hasOwnProperty(e) && "function" == typeof this.behaviors[e].detach
            ...
            t &&
              setTimeout(() => {
                ...
                e.hasClass("menu-item-has-block has-dropdown") &&
                  ...
                  (n && jQuery(".header-vertical-menu__fly-out").addClass("header-vertical-menu__fly-out--open"),
                  ...
                  !(function (e, t) {
                    (jQuery.fn.tooltipster ? Promise.resolve() : n.e(635).then(n.t.bind(n, 2650, 23))).then(() => {
                      e.hasClass("tooltipstered") ||
                        e.tooltipster({ theme: "tooltipster-default", delay: 10, animationDuration: 300, ...t }),
                        e.tooltipster("show");
                    });
                  })(i, e);
                });
              ...
              return (function (e, t) {
                ...
                function r(e, t, s) {
                  ...
                  "string" == typeof e && (c = document.querySelectorAll(e)),
                    c
                      ? ((this.elements =
                          ((l = c), Array.isArray(l) ? l : "object" == typeof l && "number" == typeof l.length ? a.call(l) : [l])),
                          ...
                          if (null !== a) {
                            ...
                            e.each(s.axis.split(""), function (e, n) {
                              ...
                              s.limit && /^\d+$/.test(p[a]) && (p[a] = p[a] <= 0 ? 0 : Math.min(p[a], g)),
                                !e && s.axis.length > 1 && (r === p[a] ? (p = {}) : l && (m(s.onAfterFirst), (p = {})));
                            }),
                              m(s.onAfter);
                          }
                          function m(t) {
                ...
                this.each((t, n) =>
                  (function (t) {
                    t.classList.add("parallax-active"),
                      (!document.querySelector("body").classList.contains("parallax-mobile") && e()) ||
                        (t.classList && t.dataset && (x.push({ element: t, type: L(t) }), T(x[x.length - 1])));
                  })(n)
                ));
          }),
        r(9207),
        ...
        e.addClass("current-dropdown"),
          ...
          (function (e) {
            ...
            s &&
              ...
              t.css({ minHeight: t.closest(".header-vertical-menu__fly-out").outerHeight() });
          })(e.find(".nav-dropdown"));
      }
      function $(e) {
                ...
                const n = jQuery(e.target),
                  ...
                  i = (e) => {
                    jQuery("body").hasClass("admin-bar") &&
                      n.before('<div class="container error"><p>Instagram error: ' + e + "</p></div>"),
          ...
          attach(t) {
            ...
            jQuery(".accordion-title", t).each(function () {
              jQuery(this)
                ...
                !n.substring(1).length ||
                  (decodeURIComponent(n.substring(1)) !== jQuery(this).attr("href")?.split("#")[1] &&
                    n.substring(1) !== jQuery(this).attr("href")?.split("#")[1]) ||
        ...
        Flatsome.behavior("tooltips", {
          attach(t) {
            jQuery(".tooltip:not(.hotspot), .has-tooltip, .tip-top, li.chosen a", t).lazyTooltipster(),
              ...
              e()
                ? jQuery(".hotspot.tooltip:not(.quick-view)", t).lazyTooltipster({ trigger: "click" })
                          ...
                          r ||
                            ...
                            "scroll" === m &&
                              e({
                                ...
                                mode: "scroll",
                                actions: [{ visibility: [b / 100, v / 100], type: g, frames: [s(y), s(u)] }],
                              }),
                            "hover" === m &&
