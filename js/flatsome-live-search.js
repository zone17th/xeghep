    ...
    (r.prototype = {
      ...
      setOptions: function (e) {
        ...
        (this.isLocal = Array.isArray(s.lookup)),
          ...
          t(this.suggestionsContainer).css({ "max-height": s.maxHeight + "px", width: s.width + "px", "z-index": s.zIndex }),
          (this.options = s);
      },
      clearCache: function () {
      ...
      isCursorAtEnd: function () {
        ...
        return "number" == typeof s
          ? s === e
          : !document.selection || ((t = document.selection.createRange()).moveStart("character", -e), e === t.text.length);
      },
          ...
          !1 !== u.onSearchStart.call(a.element, u.params) &&
            ...
            t.isFunction(u.lookup)
              ...
              : (a.isLocal
                  ...
                  : (t.isFunction(l) && (l = l.call(a.element, e)), (n = l + "?" + t.param(i || {})), (s = a.cachedResponse[n])),
                s && Array.isArray(s.suggestions)
                  ? ((a.suggestions = s.suggestions), a.suggest(), u.onSearchComplete.call(a.element, e, s.suggestions))
                  : a.isBadQuery(e)
                  ? u.onSearchComplete.call(a.element, e, [])
                  : (a.abortAjax(),
                    (o = { url: l, data: i, type: u.type, dataType: u.dataType }),
      ...
      onHint: function (e) {
        ...
        e && (i = this.currentValue + e.value.substr(this.currentValue.length)),
          this.hintValue !== i && ((this.hintValue = i), (this.hint = e), t.isFunction(s) && s.call(this.element, i));
      },
      ...
      processResponse: function (t, e, s) {
        ...
        (t.suggestions = this.verifySuggestionsFormat(t.suggestions)),
          i.noCache || ((this.cachedResponse[s] = t), i.preventBadQueries && !t.suggestions.length && this.badQueries.push(e)),
      ...
      activate: function (e) {
        ...
        return (
          ...
          -1 !== this.selectedIndex && o.length > this.selectedIndex ? ((s = o.get(this.selectedIndex)), t(s).addClass(i), s) : null
        );
      },
      selectHint: function () {
        ...
        if (s) {
          ...
          (i = s.offsetTop),
            ...
            i < n
              ...
              : i > o && t(this.suggestionsContainer).scrollTop(i - this.options.maxHeight + a),
      ...
      return arguments.length
        ? this.each(function () {
            ...
            "string" == typeof e
              ...
              : (n && n.dispose && n.dispose(), (n = new r(this, e)), i.data("autocomplete", n));
          })
